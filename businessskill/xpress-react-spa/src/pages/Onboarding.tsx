    ...
    <div className="flex flex-col w-full pb-24">
      ...
      <section className="w-full max-w-5xl mx-auto px-8 py-16 flex flex-col justify-center min-h-[calc(100vh-120px)] shrink-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white border border-[#e8e6df] rounded-3xl p-8 shadow-sm relative hover:shadow-md transition-shadow">
            ...
            <div className="bg-[#FAF7F0] rounded-2xl p-4 flex items-center justify-between border border-[#e8e6df]">
              ...
              <button className="bg-[#49704F] text-white text-[13px] font-bold px-4 py-2 rounded-xl hover:bg-[#346E56] transition-colors">
                Open Store
              </button>
            </div>
          </div>
          ...
          <div className="bg-[#FAF7F0] border-2 border-dashed border-[#dcd9ce] rounded-3xl p-8 flex flex-col items-center justify-center text-center relative group">
            ...
            <button className="bg-white border border-[#dcd9ce] text-[#233227] text-[14px] font-bold px-8 py-3 rounded-full hover:bg-[#FAF7F0] shadow-sm transition-all mb-4">
              Download Files
            </button>
            <p className="text-[12px] text-[#8e9892]">File size: 2.5MB</p>
          </div>
        ...
        <div className="flex justify-between items-center w-full">
          <button className="flex items-center gap-2 text-[14px] font-bold text-[#5c6860] hover:text-[#233227] transition-colors">
            <span className="material-symbols-outlined text-[18px]">arrow_back</span> Back to Docs
          </button>
          <button 
             onClick={() => {
            ...
            className="flex items-center gap-2 bg-[#a3bfae] text-white text-[15px] font-bold px-6 py-3 rounded-full hover:bg-[#49704F] cursor-pointer transition-colors shadow-sm"
          >
