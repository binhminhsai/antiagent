        ...
        <div className="xl:col-span-2 bg-surface-container-low p-8 rounded-2xl border border-outline-variant/30 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <button 
              ...
              disabled={syncing}
              className={`flex flex-col items-start p-6 rounded-xl border transition-all active:scale-[0.98] ${syncing ? 'bg-surface-container-highest border-outline-variant cursor-wait' : 'bg-surface-container-highest border-outline-variant hover:border-primary group bg-white'}`}
            >
